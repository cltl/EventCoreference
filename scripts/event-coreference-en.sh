...
java -Xmx812m -cp "$LIB/EventCoreference-v3.0-jar-with-dependencies.jar" eu.newsreader.eventcoreference.naf.EventCorefWordnetSim --method leacock-chodorow --wn-lmf "$RESOURCES/wneng-30.lmf.xml.xpos.gz" --sim 2.0 --sim-ont 0.6 --wsd 0.8 --relations $REL wn-prefix "eng" --source-frames "$RESOURCES/source.txt" --grammatical-frames "$RESOURCES/grammatical.txt" --contextual-frames "$RESOURCES/contextual.txt"
