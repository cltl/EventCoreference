 ...
 */
public class TrigToJsonPerspectiveTimeLineClimax {
...
/*
            jsonObjectArrayList = JsonStoryUtil.mergeEvents(jsonObjectArrayList);
            System.out.println("Events after merge = " + jsonObjectArrayList.size());
*/
